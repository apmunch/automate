...
cmd.exe /c "netstat -rn >> C:\Users\%username%\AppData\Temp\a.txt"
cmd.exe /c "systeminfo >> C:\Users\%username%\AppData\Temp\a.txt"
cmd.exe /c "net group "Domain Admins" /domain >> C:\Users\%username%\AppData\Temp\a.txt"
